...
class MainActivity : ComponentActivity() {
        ...
        setContent {
            TestApp1Theme {
                ...
                Surface(
                    ...
                    /* GreetingImage(message = "Happy new month", from = "Dany")*/
                    ArtSpace()
                }
    ...
    fun Article(modifier: Modifier = Modifier) {
        Column(modifier) {
            ...
            Text(
                ...
                fontSize = 23.sp, modifier = modifier.padding(16.dp), textAlign = TextAlign.Justify
            )
            Text(
    ...
    fun ToDoList(modifier: Modifier = Modifier) {
        ...
        Column(
            modifier.padding(45.dp, 100.dp, 45.dp, 100.dp), verticalArrangement = Arrangement.Center,
            ...
            Text(
                text = stringResource(R.string.todoTitle),
                fontSize = 24.sp, fontWeight = FontWeight.Bold,
                modifier = modifier.padding(0.dp, 16.dp, 0.dp, 16.dp)
            )
            Text(
                text = stringResource(R.string.todoContent),
        ...
        Column(modifier.background(Color(0xFF75d2ac))) {
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.carteTitle),
                        fontSize = 40.sp, fontWeight = FontWeight.Bold,
                        textAlign = TextAlign.Center,
                    )

                    Text(
                        text = stringResource(R.string.carteContent),
    ...
    fun ArtSpace(modifier: Modifier = Modifier) {
        ...
        val artworks = listOf(
            ArtworkItem(R.drawable.kenne, R.string.Pic1, R.string.Artist1, R.string.Year1),
            ArtworkItem(R.drawable.dany_chilling, R.string.Pic2, R.string.Artist2, R.string.Year2),
            ArtworkItem(R.drawable.dan, R.string.Pic3, R.string.Artist3, R.string.Year2),
            ArtworkItem(R.drawable.ken, R.string.Pic4, R.string.Artist4, R.string.Year2),
            ArtworkItem(R.drawable.sailing_boat, R.string.Pic5, R.string.Artist5, R.string.Year4),
            ArtworkItem(R.drawable.pro_intership, R.string.Pic6, R.string.Artist6, R.string.Year5),
        )
        ...
        Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(artworks[currentIndex].titleResId),
                        fontSize = 24.sp,
                        fontWeight = FontWeight.Bold
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(
                        text = "${stringResource(artworks[currentIndex].artistResId)} (${stringResource(artworks[currentIndex].yearResId)})",
                        fontSize = 16.sp
                    )
                }
            }
